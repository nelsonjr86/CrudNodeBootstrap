...
.post((req, res) => {
  ...
  db.collection('data').save(req.body, (err, result) => {
    ...
    console.log(`Salvo no Banco de Dados!  Nome: ${name}, Sobrenome: ${surname} `)
    res.redirect('/show')
  })
})
...
.post((req, res) => {
  ...
  db.collection('data').updateOne({_id: ObjectId(id)}, {
    ...
    if (err) return res.send(err)
    res.redirect('/show')
    console.log(`Atualizado no Banco de Dados! Nome: ${name}, Sobrenome: ${surname} `)
  })
})
...
.get((req, res) => {
  ...
  db.collection('data').deleteOne({_id: ObjectId(id)}, (err, result) => {
    ...
    console.log(`Deletado do Banco de Dados! Nome: ${name}, Sobrenome: ${surname} `)
    res.redirect('/show')
  })
})
